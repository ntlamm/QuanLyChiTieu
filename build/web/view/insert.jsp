        ...
        <div class="row" style="width: 100%">
            ...
            <div style="width: 80%">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-5">
                        <form role="form" method="POST" action="them" onsubmit="return check()">
                            <h2 style="text-align: center"><i class="bi bi-credit-card-fill" style=" font-size:2rem"></i> Thêm chi tiêu</h2>                            
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập tên" name="cname" />                                                            
                            </div>
                            <div class="form-group">
                                <h5><i class="bi bi-cash-coin"></i> Số tiền</h5>
                                <input type="number" class="form-control" placeholder="Nhập số tiền" name="cprice" />                                                             
                            </div>
                            <div class="form-group">
                                <h5><i class="bi bi-clipboard-fill"></i> Ghi chú</h5>
                                <input type="text" class="form-control" placeholder="Nhập ghi chú" name="cnote" />                                                             
                            </div>                           
                            <div class="form-group">
