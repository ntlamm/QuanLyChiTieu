        ...
        <div class="row" style="width: 100%">
            ...
            <div style="width: 80%">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-5">
                        <form role="form" action="themkehoach" method="POST" onsubmit="return check()">  
                            <h2 style="text-align: center"><i class="bi bi-clipboard-plus" style=" font-size:2rem"></i> Thêm kế hoạch</h2>
                            <c:forEach items="${requestScope.groups}" var="g">
                                <c:if test="${g.cgroupid==requestScope.id}">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="cgroupid" class="form-control" value="${requestScope.id}"/>                                
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  class="form-control" placeholder="Nhập số tiền" name="pprice" />
                            </div>                            
